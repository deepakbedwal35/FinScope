export default function QuarterlyResult({quarterly}){

    return(
        <div>

            
            <div className="p-2 text-lg font-medium text-amber-200">Quarterly Result (Last 4 Quarter)</div>
            {quarterly.length == 0 && <div className="text-center text-sm font-light text-cyan-300"> No Recent data Found</div>}
            {quarterly.length > 0 &&  <div>
