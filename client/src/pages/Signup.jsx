...
export default function Signup(){
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
        ...
        // Force execution to await the response
        await userApi.post("/user/signup", formData , {withCredentials : true})
        .then((res) => {
    ...
    <div className="w-full lg:w-1/2 bg-slate-900 flex items-center justify-center px-10">
      <div className="w-full max-w-sm">
        ...
        <p className="text-slate-400 text-sm mb-8">Sign up to your account</p>
